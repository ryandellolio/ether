...
var save = dnsDB('dns#v1-1.dellol.io', "key", true, function ( db ){  //creates a sqlite3 db from a DNS call.  true denotes write mode
    ...
    db.serialize(function() {         //use as you normally would per https://www.npmjs.com/package/sqlite3
        ...
        db.exec("INSERT INTO content VALUES(9,'description','<p>Stella</p>')");
